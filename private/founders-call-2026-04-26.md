...
### 1 · Role + scope alignment (15 min)

**Mitchell — CEO**
- Investor-side: deck, raise, lead investor relations, term sheet ownership
- Customer-side: pro/college performance staff conversations
- DoD business development direct (per Luke's active-duty constraint)
- Public-facing channels: Klemic, Dudeck, Pederson, Papale, athletes, VCs

**Luke — CTO**
- Engineering, hardware, full physical product lifecycle
- Source/manage external design firms, mech/elec engineers, CNC + prototyping
- Translate product + sensor requirements into engineering specs
- Build manufacturing path: prototype → small batch → scale
...
### 2 · The Adam question — Luke as co-founder vs. advisor (10 min)

**Adam's flag (paraphrased):** "Active-duty military founders sometimes work better as advisors with full conversion at exit, not co-founders during service."

**Mitchell's read:** *Co-founder, no change.* Active duty is a 4–5 year ramp, not a permanent constraint. Equity stays at 5% common with vesting; what we adjust is *external positioning* — Mitchell runs investor calls + DoD BD direct, Luke's CTO is external branding until status shifts. We've already structured for this.

**What I want from Luke on the call:**
- Does this framing feel right *to him* — or does the advisor track feel cleaner given the schedule he's actually living?
- Anything he heard from the JAG / mil-side lawyer that argues for advisor status specifically?
- Any second-order effects we're missing (security clearance, command perception, post-retirement payout structure)?

**Decision needed:** confirm co-founder, or pivot to advisor before RSPA executes. **This must be settled before Wed Apr 29 RSPA execution.**
...
**Decision needed:**
- Confirm Apr 29 Wed as Luke's RSPA target date
- Backup plan if Colonel slips beyond Tue May 5

---

### 4 · Prospect awareness — both directions (15 min)

**Mitchell's warm channels (sent or drafted):**

| Contact | Lane | Status |
|---|---|---|
| Dave Klemic | Performance / pilot site / NFL Alumni network | ✅ Sent Apr 25 |
| Dave Dudeck | Bears scout, internal bridge to Performance | Hold (decision Apr 25) |
| Doug Pederson | Eagles HC alumni; coach-side validator | Parent-forward queued |
...
| Contact / org | Lane | Status |
|---|---|---|
| 711 HPW (AFRL) | SBIR pathway, prior admin role | Luke-owned, framework TBD |
| Special Warfare training wings | Operator-adjacent training data | Luke-owned |
| Operator squadrons | Direct user / pilot data candidates | Luke-owned |
| Adam Lisa (Luke's brother) | Manufacturing ops / vendor sourcing | Parked, no urgency |
| Natalia Lisa (Luke's wife) | PM / UX (Google UX course in progress) | Parked, no urgency |
| Luke's father | Manufacturing ops / vendor advisor | Informal-advisor convo pending |

**Decision needed — handoff protocol:**
- When Klemic responds with NFL Alumni intros, who handles them?
- When Luke is approached on AFRL / SBIR side, what's the trigger to bring Mitchell in vs. Luke staying in front?
- Standing rule: Mitchell on every customer-buyer conversation while Luke is active duty (per current scope refinement)

---

### 5 · 90-day plan alignment (10 min)

**Through end of Q2 2026 (May–June):**
...
**Decision needed:** anything on this list that's mis-prioritized given individual capacity?

---

### 6 · Open whiparound (10 min)

Anything either of you wants to raise that isn't above. No restrictions. Topics that *might* surface:
- Slack — set up now or wait?
- Board structure post-seed (lead investor seat? Adam observer?)
- IP policy / employee CIIAA when first hire lands
- Press / launch positioning timing

---

## Decisions to lock on the call
...
## Action items (fill in on the call)
