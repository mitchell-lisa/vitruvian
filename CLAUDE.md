...
### Formation & legal
- **C-corp:** Filed via Stripe Atlas Apr 20, 2026. **EIN 42-2107337 issued by IRS, confirmed Apr 23, 2026.** Delaware file number 10592524. Registered agent: Legalinc Corporate Services Inc. (active through Apr 20, 2027). **EIN stored in `private/company-formation.md` — do not output in chat or paste into public docs.**
...
- **Bank:** Mercury / Brex — **UNBLOCKED.** Open this week. Mercury preferred (Atlas integration).
