...
- **RSPAs (Luke, Andrew):** **No self-serve platform works** — Atlas self-serve is single-founder-at-formation only; Clerky won't onboard Atlas-formed entities. Confirmed Apr 24 2026. **Outside counsel is the only path.** Dead paths: ~~Richard/KAS portfolio counsel~~ (hands-off fund, no referrals) and ~~dad's lawyer Kirk Pavoni (D'Elia Law Firm)~~ (South Jersey real-estate/commercial-litigation practice, wrong specialty). **Active path: Atlas Plus ($500/yr) → Cooley/Orrick/Gunderson partner firm, $2–5K, 1–2 week turnaround. Execute Monday Apr 27 AM.** Fallback: Lowenstein Sandler (NJ-local) or Founders Legal (remote, fixed-fee) if Atlas partners decline. Mechanism = company repurchase of 1M shares from Mitchell at par + contemporaneous reissuance with vesting to Luke (500K) + Andrew (500K). Preserves Mitchell QSBS clock; fresh clocks for Luke + Andrew. See `private/execution-tracker.md` and `private/legal-templates/README.md`.
...
- **Andrew Lisa:** Co-Founder · Head of Finance (CFO track). **5% common, 4-yr vest, 1-yr cliff — verbally accepted Apr 21 2026.** Role memo drafted (`private/andrew-role-memo.md`). **EIN now live — RSPA unblocked, issue this week alongside Luke's. Andrew's 83(b) 30-day clock starts at grant date.** Photo + bullets live on pitch.html team slide.
