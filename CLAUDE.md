...
- **Adam Evans:** **Call completed Tue Apr 22 2026 @ 2:30 PM EST. Advisor role verbally accepted.** Upgraded from FAST Gold (0.5%) to **FAST Platinum (1.0% common options, 2-yr vest, no cliff)** on strength of call: PhD, 25 yrs teaching entrepreneurship (U Kentucky Chair), 8 yrs Chief Strategy Officer at DoD-serving mil-tech startup, AFWERX/SOFWERX judge, FSMTB-MBLEX EDC national board seat. Role memo drafted (`private/adam-role-memo.md`). Photo + bullets live on pitch.html team slide. **Apr 25 2026: Mutual NDA drafted** (`private/legal-templates/drafts/Adam-Evans-Mutual-NDA.{md,docx,pdf}`) — DE law, 2-yr term, mutual disclosure, ready for DocuSign upload + send. FAST Platinum still pending counsel. Adam gave substantive deck feedback (see below). **Flagged Luke-as-advisor-vs-co-founder strategic question** based on his 8 yrs of mil-tech experience — agenda item for the Apr 26 founders call (`private/founders-call-2026-04-26.md`). **Recap text sent to Luke Apr 22 2026** looping him in on Adam's yes + teasing bigger strategic items.
- **Andrew Lisa:** Co-Founder · Head of Finance (CFO track). **5% common, 4-yr vest, 1-yr cliff — verbally accepted Apr 21 2026.** Role memo drafted (`private/andrew-role-memo.md`). **EIN now live — RSPA unblocked, issuing next week via Atlas Plus partner firm route (Atlas + Clerky DIY paths both confirmed dead).** Andrew's 83(b) 30-day clock starts at grant date. Photo + bullets live on pitch.html team slide. **Apr 25 2026:** Andrew provisioned on `andrew@modulor.bio` (logged in + password changed); Mercury access pending. **Capacity confirmed at 5–10 hrs/wk** at UBS, ramps post-seed. First three-task scope assigned: (1) $3M use-of-funds model v1 by end of April, (2) cap table on Pulley once admin upgrades post-RSPA, (3) Mercury weekly transaction review.
