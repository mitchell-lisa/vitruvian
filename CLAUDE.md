...
2. **Finish formation legals.** Luke RSPA + 83(b); Adam FAST Platinum; EIN from IRS; Mercury bank; USPTO trademark (Classes 9, 10, 41); D&O insurance before first investor check. *(Andrew RSPA killed Apr 25 — Andrew stepped out.)*
...
### Confirmed
- **Mitchell Lisa** — founder/CEO. 88% common (→83% post-Luke RSPA). Based NJ.
...
### Departed / declined
- **Andrew Lisa** — was co-founder, CFO (5% common, 4-yr vest, 1-yr cliff, verbally accepted Apr 21 2026). **Stepped out Apr 25 2026.** Texted "I don't think I'm the right person for this endeavor… happy to help and give you money as an investor but I know I'm not going to do any of that realistically… wouldn't be fair to you if you are serious and I'm not giving my full effort." Mitchell accepted clean ("rather know now"). No paper signed — verbal-only acceptance, RSPA never executed, no 83(b) clock to unwind. **Andrew may still come in as a passive seed-round investor; no equity grant, no advisory role assumed.** Photo + bullets came off pitch deck. UBS Executive Director, Real Estate Finance (9 years). UPenn Wharton Economics '16. Mitchell's brother.
...
### Open seat
- **Finance lead / fractional CFO.** Andrew was queued for cap-table, $3M use-of-funds model, Mercury weekly review, term-sheet defense. With his exit, these revert to Mitchell or get outsourced. Options: (a) carry it on Mitchell + outside counsel + Pulley/Carta through seed close, (b) bring on a fractional CFO post-close (Burkland, Pilot CFO, Kruze, Graphite), (c) make it a hire after Series A. **Default = (a) through seed close, (b) at Series A prep.** Do not chase a replacement co-founder for the seat — Andrew's leverage was credibility on the team slide, not finance ops we can't outsource.
...
| `private/andrew-role-memo.md` | Andrew's title, equity, vesting *(historical — Andrew stepped out Apr 25 2026)* |
...
### Formation & legal
- **C-corp:** Filed via Stripe Atlas Apr 20, 2026. **EIN 42-2107337 issued by IRS, confirmed Apr 23, 2026.** Delaware file number 10592524. Registered agent: Legalinc Corporate Services Inc. (active through Apr 20, 2027). **EIN stored in `private/company-formation.md` — do not output in chat or paste into public docs.** Luke + Adam each need separate 83(b) / option filings when their RSPA / FAST Platinum execute. *(Andrew was queued for an RSPA + 83(b); not needed — he stepped out Apr 25 before paper.)*
- **83(b) election (Mitchell):** ✅ **FILED Apr 28, 2026.** Stripe Atlas confirmed via email — postmarked Apr 28, well inside the 30-day window (closed Stripe-calc May 23 / our-calc May 20). USPS tracking `9207190235890900003893​8966`. Signed election + proof of filing available in Atlas Documents tab. **Action:** download both + a USPS "Accepted at Regional Origin Facility" screenshot → save to `private/formation-docs/` (gitignored). No further action on Mitchell's 83(b).
...
- **RSPA (Luke only):** **No DIY platform from Atlas or Clerky.** Atlas self-serve is single-founder-at-formation only; Clerky won't onboard Atlas-formed entities. **Pulley DOES accept Atlas entities** — investigate whether Pulley's RSPA flow handles post-formation founder-to-founder transfer with QSBS preservation (Apr 25–27). Confirmed Apr 24 2026. Paths: Dead: ~~Richard/KAS portfolio counsel~~ (hands-off, no refs). Pending: dad's lawyer Kirk Pavoni (email sent Apr 24 asking for corporate-counsel referral in his network — D'Elia itself is real estate / commercial litigation, wrong specialty). **Active: (1) Pulley investigation Apr 25–27, (2) Atlas Plus ($500/yr) → Cooley/Orrick/Gunderson partner firm $2–5K, 1–2 wk turnaround, execute Monday Apr 27 AM regardless — either primary path or second-opinion on Pulley.** Fallback: Lowenstein Sandler (NJ-local) or Founders Legal (remote, fixed-fee). **Mechanism (revised post-Andrew exit Apr 25):** company repurchases 500K shares from Mitchell at par + contemporaneous reissuance with vesting to Luke (500K). Mitchell holds 83% post-issuance (was 78% under the two-grant plan). Preserves Mitchell QSBS clock; fresh clock for Luke. See `private/execution-tracker.md` and `private/legal-templates/README.md`.
- **Cap table platform:** **Leaning Pulley** (Apr 24) — free <25 stakeholders, accepts Atlas entities (unlike Clerky), Stripe-backed, founder-friendly. Carta is fallback (more universal with VCs, but gets expensive past free tier). Pick one, commit — dual cap tables create drift bugs.
...
- **Investor agreements:** YC post-money SAFE from `ycombinator.com/documents`. **Outside counsel red-lines every instance before Mitchell signs** *(was Andrew's red-line workstream before he stepped out — now Atlas Plus partner firm or Lowenstein/Founders Legal)*.
...
### Team
- **Luke:** On board. Text summary of role memo sent Apr 21 2026; Luke replied with feedback Apr 21. Agreed on 4-yr vest, 1-yr cliff; 83(b) explained. **Scope refined: Luke's military access = advisor/strategy/contacts only while active duty — direct customer negotiations and contracting led by Mitchell.** Correct venues: **711 HPW (AFRL), Special Warfare training wings, operator squadrons** (not AFWERX/SOFWERX as personal access channels — those remain valid GTM pathways). SBIR grant workstream added (Luke prior AFRL administrator). **USAF off-duty employment form (Apr 22 2026):** filled out using Modulor, Inc. / 1111B S Governors Ave STE 27384, Dover DE 19904 / (609) 760-1238. **Apr 23 2026: CO base/mil-side lawyer verbally cleared current scope — "good as we start up." Ethics counselor form submitted Apr 23 afternoon ("should be non-issue"). Formal "letter of disqualification" (recusal from any US Gov financial/contract decisions connected to Modulor) deferred until we actually pursue DoD research contracts or sales.** **Apr 24 2026: EIN 42-2107337 live — RSPA unblocked, issuing this week. Luke's 83(b) 30-day clock starts at grant date.** Luke provisioned in Google Workspace (`luke@modulor.bio`) + added to Mercury (Bookkeeper role, upgrade to Admin post-RSPA).
- **Adam Evans:** **Call completed Tue Apr 22 2026 @ 2:30 PM EST. Advisor role verbally accepted.** Upgraded from FAST Gold (0.5%) to **FAST Platinum (1.0% common options, 2-yr vest, no cliff)** on strength of call: PhD, 25 yrs teaching entrepreneurship (U Kentucky Chair), 8 yrs Chief Strategy Officer at DoD-serving mil-tech startup, AFWERX/SOFWERX judge, FSMTB-MBLEX EDC national board seat. Role memo drafted (`private/adam-role-memo.md`). Photo + bullets live on pitch.html team slide. **Apr 28 2026: Mutual NDA regenerated** (`build/drive-upload/07_Legal/Adam-Evans-Mutual-NDA.{md,docx,pdf}` — source-of-truth `scripts/legal_sources/adam_evans_mutual_nda.py`, render via `scripts/render_legal_doc.py`) — DE law, 2-yr term, mutual disclosure, ready for DocuSign upload + send. FAST Platinum still pending counsel. Adam gave substantive deck feedback (see below). **Flagged Luke-as-advisor-vs-co-founder strategic question** based on his 8 yrs of mil-tech experience — agenda item for the Apr 26 founders call (`private/founders-call-2026-04-26.md`). **Recap text sent to Luke Apr 22 2026** looping him in on Adam's yes + teasing bigger strategic items.
- **Andrew Lisa: STEPPED OUT Apr 25 2026.** Verbally accepted CFO role Apr 21 (5% common, 4-yr vest, 1-yr cliff); withdrew via text Apr 25 1:34 PM after Mitchell asked him to start eyeballing Mercury weekly + join the Apr 26 founders call. Andrew's words: *"I don't think I'm the right person for this endeavor. Happy to help and give you money as an investor but I know I'm not going to do any of that realistically. I'm sorry. But wouldn't be fair to you if you are serious about this and I'm not giving my full effort."* Mitchell replied: *"it's fine would rather know now - thanks."* **Clean exit — no paper signed, RSPA never executed, no 83(b) clock, nothing to unwind.** Andrew remains a potential passive seed investor (no equity grant; standard SAFE if he opts in). **Tear-down in progress (Apr 25):** photo + bullets pulled from pitch.html team slide; cap-table.html reverts to Mitchell 83% post-Luke / Mitchell + Luke + Adam only; role memo flagged TERMINATED; founders-call agenda for Apr 26 strips Andrew action items; `andrew@modulor.bio` and `hello@` group membership: pending decision (default = remove, since he's not on the cap table); Mercury Bookkeeper invite never went out, no rollback needed. **Workstreams reverting to Mitchell or outside counsel:** $3M use-of-funds model (Mitchell + Pulley/Carta cap-table tooling), cap-table maintenance (Pulley), Mercury weekly transaction review (Mitchell direct), term-sheet red-lining (outside counsel). Founders QA packet entry on family-biz needs revising — answer is now Mitchell + Luke (cousins), not Mitchell + Andrew (brothers).
...
### Fundraise
- **Deck:** Live at `modulor.bio/pitch`. **Team slide (post-Andrew exit Apr 25): Mitchell + Luke + Adam (advisor) — three cards, finance seat open and not surfaced on the deck.** Family photo removed. Adam's deck fixes applied. *(Headline + intro copy on Slide 14B updated to drop "Wharton finance lead" framing; should reread as "product founder, warfighter engineer, DoD-tested advisor.")*
- **Investor outreach — first sends out Apr 22 2026:**
  ...
  - **Companyon Ventures — Andrew Berg (Director)**. Series A–focused (Boston/NY/LA, software + AI). Positioned for **feedback + relationship-building, target engagement for Series B**. Bump Tue Apr 29 if silent. companyon.vc. *(Note: this Andrew Berg is the Companyon Director — unrelated to Andrew Lisa, Mitchell's brother who stepped out of the founding team Apr 25 2026.)*
...
- **Email:** `mitchell@modulor.bio` alias live on Mitchell's account (primary of record remains `mitchell.lisa@modulor.bio` — don't touch). `hello@modulor.bio` Google Group live for public inbound (investors/partners/press) — this is the deck/feedback-form address; Luke is the second founder member (Andrew was added Apr 25; **remove Andrew from `hello@` group post Apr 25 exit**). `mitchell@` reserved for warm intros and one-to-one relationships. Luke's user to be provisioned as `luke@modulor.bio` primary (short-form directly, matching Grok's input that everyone calls him Luke); `matthew.luke@` silent alias for legal-name edge cases. **`andrew@modulor.bio`: suspend the user (don't delete — preserves audit trail of brief access window) and revoke `hello@` group membership.**
...
- **Slack:** Not yet set up. Defer — with Andrew out, two-person founders comms (Mitchell + Luke) stays on iMessage / email.
